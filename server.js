...
io.on('connection', (socket) => {
  ...
  socket.on(ACTIONS.CODE_CHANGE, ({ roomId, val }) => {
    socket.in(roomId).emit(ACTIONS.CODE_CHANGE, { val })
  })
  ...
  socket.on(ACTIONS.SYNC_CODE, ({ socketId, val }) => {
    io.to(socketId).emit(ACTIONS.CODE_CHANGE, { val })
  })
